...
<script src="{{ asset('matrix/js/jquery.flot.min.js') }}"></script>
<script src="{{ asset('matrix/js/jquery.flot.resize.min.js') }}"></script>
<script src="{{ asset('matrix/js/jquery.peity.min.js') }}"></script>
<script src="{{ asset('matrix/js/fullcalendar.min.js') }}"></script>
